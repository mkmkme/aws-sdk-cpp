...
void CoreErrorsMapper::InitCoreErrorsMapper()
{
    ...
    s_CoreErrorsMapper->emplace("QpsLimitExceeded", AWSError<CoreErrors>(CoreErrors::SLOW_DOWN, true));
    s_CoreErrorsMapper->emplace("TotalQpsLimitExceeded", AWSError<CoreErrors>(CoreErrors::SLOW_DOWN, true));
